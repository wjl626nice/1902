...
class Article(models.Model):
    ...
    # 图片上传
    pic = models.CharField(max_length=200, default='', verbose_name='图片')
    flag = CustomeTinyIntField(max_length=1, default=0, verbose_name='文章推荐 0默认 1置顶 2 推荐')
    add_time = CustomeTimeStampField(default=datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S'), verbose_name='添加时间')
